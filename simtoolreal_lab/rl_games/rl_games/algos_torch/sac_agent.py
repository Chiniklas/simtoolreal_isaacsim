...
from reference.rl_games.rl_games.common import experience
from reference.rl_games.rl_games.common.a2c_common import print_statistics
    ...
    def train(self):
        ...
        while True:
            ...
            if self.game_rewards.current_size > 0:
                ...
                self.writer.add_scalar('rewards/time', mean_rewards, self.frame)
                self.writer.add_scalar('episode_lengths/step', mean_lengths, self.frame)
                self.writer.add_scalar('episode_lengths/time', mean_lengths, self.frame)
