import reference.rl_games.rl_games.envs.test
from reference.rl_games.rl_games.common import wrappers
from reference.rl_games.rl_games.common import tr_helpers
from reference.rl_games.rl_games.envs.brax import create_brax_env
from reference.rl_games.rl_games.envs.envpool import create_envpool
from reference.rl_games.rl_games.envs.cule import create_cule
import gym
...
def create_slime_gym_env(**kwargs):
    ...
    from reference.rl_games.rl_games.envs.slimevolley_selfplay import SlimeVolleySelfplay
    name = kwargs.pop('name')
    limit_steps = kwargs.pop('limit_steps', False)
...
def create_connect_four_env(**kwargs):
    from reference.rl_games.rl_games.envs.connect4_selfplay import ConnectFourSelfPlay
    name = kwargs.pop('name')
    limit_steps = kwargs.pop('limit_steps', False)
    self_play = kwargs.pop('self_play', False)
    if self_play:
...
def create_smac(name, **kwargs):
    from reference.rl_games.rl_games.envs.smac_env import SMACEnv
    frames = kwargs.pop('frames', 1)
...
def create_multiwalker_env(**kwargs):
    from reference.rl_games.rl_games.envs.multiwalker import MultiWalker
    env = MultiWalker('', **kwargs) 

    return env

def create_diambra_env(**kwargs):
    from reference.rl_games.rl_games.envs.diambra.diambra import DiambraEnv
